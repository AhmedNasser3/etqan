...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('circle_student_bookings', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('plan_details_id'); // يوم الحصة
            $table->unsignedBigInteger('plan_circle_schedule_id'); // الميعاد
            ...
            // ✅ أهم تعديل هنا
            // المستخدم لا يمكنه حجز نفس الـ schedule مرتين
            $table->unique(
                ['plan_circle_schedule_id', 'user_id'],
                'schedule_user_unique'
            );

            // ❌ تم حذف:
            // plan_day_user_unique
