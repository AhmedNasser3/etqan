...
const UpdateCenterPage: React.FC<UpdateCenterPageProps> = ({
    ...
    const handleSubmit = async (formDataSubmit: FormData) => {
        ...
        try {
            ...
            const response = await fetch(`/api/v1/super/centers/${centerId}`, {
                method: "POST",
                credentials: "include",
                headers: {
    ...
    return (
        <>
            <div className="ov on">
                <div className="modal">
                    <div className="mh">
                        <span className="mh-t">تعديل مجمع</span>
                        <button
                            className="mx"
                            onClick={onClose}
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        className="hidden"
                                        id="logo-upload-center-update"
                                        disabled={isSubmitting}
                                    />
                                    <label
                                        htmlFor="logo-upload-center-update"
                                        style={{
                                            display: "flex",
