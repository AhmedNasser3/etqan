...
const UpdateCenterPage: React.FC<UpdateCenterPageProps> = ({
    initialCenter,
    centerId,
    onClose,
    onSuccess,
    ...
    const {
        ...
        submitForm,
        logoPreview,
    } = useCenterForm(initialCenter || undefined);

    const handleSubmit = async (formData: FormData) => {
        if (!centerId) {
            toast.error("معرف المجمع مطلوب");
            return;
        }
        ...
        try {
            ...
            const response = await fetch(`/api/super/centers/${centerId}`, {
                method: "POST",
                    ...
                    <div className="ParentModel__inner">
                        ...
                        <div className="ParentModel__main">
                            <div className="ParentModel__date">
                                <p>
                                    {initialCenter?.circleName || "مجمع جديد"}
                                </p>
                            </div>
                            <div className="ParentModel__innerTitle">
                                <h1>تعديل بيانات المجمع</h1>
                                <p>
                                    يرجى تحديث بيانات المجمع المعتمد بشكل صحيح
                                </p>
                            </div>
                        </div>
