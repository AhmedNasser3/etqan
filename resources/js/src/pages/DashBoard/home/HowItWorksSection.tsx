        ...
        <div className="howtWorks" ref={sectionRef}>
            <div className="howtWorks__inner">
                <div className="howtWorks__container">
                    ...
                    >
                        <h1>كيف يعمل نظام التقارير لدي إتقان</h1>
                        <p>تعرف علي طريقة عمل التقارير في منصة إتقان</p>
                    </div>
                    <div className="howtWorks__data">
                        ...
                        >
                            ...
                            <h2>
                                1.تسجيل لافاد الحلقة او المجمع (طلاب, موظفين)
                            </h2>
                            <p>ابدأ رحلتك مع المنصة من خلال تسجيل مجمع جديد</p>
                        </div>
                        ...
                        >
                            ...
                            <h2>2. حساب التقارير</h2>
                            <p>
                                يتم حساب تقارير الرواتب والحضور و الحلقات واكثر
                                بكثير وتعرض لك في شاشة واحدة
                            </p>
                        </div>
                        <div className="howtWorks__rows_container">
                            <span
                        ...
                        >
                            ...
                            <h2>3. التنزيل</h2>
                            <p>
                                يمكنك ان تشاهد تقاريرك او تقو بتنزيلها في اي وقت
                            </p>
                        </div>
                    </div>
                </div>
