    ...
    return (
        <div className="userProfile__plan">
            ...
            <div className="userListening">
                ...
                <div className="userListening__features">
            ...
            <div className="userProgress__content" style={{ margin: "24PX 0" }}>
                <div className="userProgress__comments">
                    ...
                    <div className="userProgress__data">
                        <h4>سورة البقرة</h4>
                        <h2>
                            محتوي الحصة :<span>حفظ من ايه 24 الي 31</span>
                        </h2>
                        <h2>مراجعة من ايه 10 الي ايه 24 </h2>
                    </div>
                    <div className="userProgress__comment">
                        <h1>تعليق المعلم :-</h1>
                        <h2>الطالب ممتاز ولم يقصر في الحفظ او اي شيئ</h2>
                    </div>
