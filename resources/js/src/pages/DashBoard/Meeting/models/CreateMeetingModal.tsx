                    ...
                    <div className="ParentModel__inner">
                        ...
                        <div className="ParentModel__main">
                            <div className="ParentModel__date">
                                <p>ميتينج جديد بين المعلم والطالب</p>
                            </div>
                            <div className="ParentModel__innerTitle">
                                <h1>إنشاء ميتينج جديد</h1>
                                <p>
                                    اختر المعلم والطالب والمركز وجدول الحصة
                                    لإنشاء رابط ميتينج فريد
                                </p>
                            </div>
                        </div>
                            ...
                            {meetingCode && (
                                <div className="inputs__verifyOTPBirth">
                                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                                        ...
                                        <p className="text-xs text-blue-700 font-mono bg-white px-3 py-2 rounded-lg">
                                            https://meet.jit.si/{meetingCode}
                                        </p>
                                    </div>
                                </div>
                            )}
