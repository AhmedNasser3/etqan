...
const PayrollExport: React.FC = () => {
    ...
    const bulkExportPDF = () => {
        setLoading(true);
        setTimeout(() => {
            alert(`تم تصدير ${selectedEmployees.length} مسير PDF مع QR`);
            setLoading(false);
        }, 3000);
    };
    ...
    const bulkExportExcel = () => {
        setLoading(true);
        setTimeout(() => {
            alert(`تم تصدير ${selectedEmployees.length} مسير Excel`);
            setLoading(false);
        }, 2500);
    };
    ...
    const sendEmail = (id: number) => {
        setLoading(true);
        setTimeout(() => {
            alert(`تم إرسال مسير الراتب إلى البريد الإلكتروني`);
            setLoading(false);
        }, 1500);
    };
