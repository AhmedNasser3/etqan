...
const FinancialDashboard: React.FC = () => {
    ...
    const handleOpenFinancialModel = () => {
        ...
        toast("تم فتح نموذج التعديل");
    };

    const handleCloseFinancialModel = () => {
        setShowFinancialModel(false);
        toast("تم إغلاق نموذج التعديل");
    };
    ...
    const handleExportPDF = () => {
        setLoading(true);
        const loadingToast = toast.loading("جاري تصدير المسير الشهري PDF...");
        setTimeout(() => {
            setLoading(false);
            toast.success("تم تصدير المسير الشهري PDF بنجاح", {
                id: loadingToast,
            });
        }, 1500);
    };
    ...
    const handleMarkPaid = (id: number) => {
        ...
        setTimeout(() => {
            ...
            setLoading(false);
            toast.success("تم تحديث الحالة إلى مدفوع بنجاح", {
                id: loadingToast,
            });
        }, 1000);
    };
