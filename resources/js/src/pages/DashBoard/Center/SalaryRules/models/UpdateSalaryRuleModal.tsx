// models/UpdateSalaryRuleModal.tsx
import { useState, useEffect } from "react";
import toast from "react-hot-toast";
import { useSalaryRuleFormUpdate } from "../hooks/useSalaryRuleFormUpdate";
...
const UpdateSalaryRuleModal: React.FC<UpdateSalaryRuleModalProps> = ({
        ...
        return (
            <div className="ov on">
                <div className="modal">
                    <div className="mh">
                        <span className="mh-t">
                            جاري تحميل بيانات قاعدة الراتب...
                        </span>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="ov on">
            <div className="modal">
                <div className="mh">
                    <span className="mh-t">تعديل قاعدة راتب</span>
                    <button
                        className="mx"
                        onClick={onClose}
                ...
                <div className="mb">
                    ...
                    <div style={{ marginBottom: 13 }}>
                        ...
                        <select
                            ...
                            className={`fi2 ${errors.role || isRoleExists ? "border-red-300 bg-red-50" : "border-gray-200 hover:border-gray-300"}`}
                            disabled={isSubmitting}
                        >
                        ...
                        {isRoleExists && (
                            <p style={errorStyle}>
                                يوجد بالفعل قاعدة راتب أخرى لهذا الدور
                            </p>
                        )}
